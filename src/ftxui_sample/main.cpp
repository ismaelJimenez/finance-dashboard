...
// configuration step. It creates a namespace called `finance_dashboard`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", finance_dashboard::cmake::project_name, finance_dashboard::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", finance_dashboard::cmake::project_version);
      return EXIT_SUCCESS;
    }
